...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { path: '', component: RestaurantListComponent, data: { animation: 'RestaurantList' } },
          { path: 'add-restaurant', component: AddRestaurantComponent, data: { animation: 'AddRestaurant' } },
          {
            path: ':id',
            children: [
              { path: '', component: RestaurantOverviewComponent, data: { animation: 'RestaurantOverview' } },
              { path: 'food-list', component: FoodListComponent, data: { animation: 'FoodList' } },
              { path: 'food-list/add-food', component: AddFoodComponent, data: { animation: 'AddFood' } },
              { path: 'food-list/:foodId/food-details', component: FoodDetailsComponent, data: { animation: 'FoodDetails' } },
              { path: 'categories', component: CategoriesComponent, data: { animation: 'Categories' } },
              { path: 'extras', component: ExtraComponent, data: { animation: 'Extras' } },
              { path: 'extras/add', component: AddExtraComponent, data: { animation: 'AddExtra' } },
            ],
          },
        ],
      },
      {
        ...
        children: [
          { path: '', component: RidersComponent, data: { animation: 'RidersList' } },
          { path: 'shifts', component: RiderShiftsComponent, data: { animation: 'RiderShifts' } },
          {
            path: ':id',
            children: [
              { path: '', redirectTo: 'overview', pathMatch: 'full' },
              { path: 'overview', component: RiderOverviewComponent, data: { animation: 'RiderOverview' } },
              { path: 'delivery', component: OrderTrackingComponent, data: { animation: 'RiderDelivery' } },
              { path: 'earnings', component: RiderDeliveryComponent, data: { animation: 'RiderEarnings' } },
              { path: 'reviews', component: RiderDeliveryComponent, data: { animation: 'RiderReviews' } },
            ],
          },
        ],
      },
      {
        ...
        children: [
          { path: '', component: CustomersComponent, data: { animation: 'CustomerList' } },
          { path: 'add-customer', component: AddCustomerComponent, data: { animation: 'AddCustomer' } },
          { path: ':id', component: CustomersOverviewComponent, data: { animation: 'CustomerOverview' } },
        ],
      },
      {
        path: 'orders',
        ...
        children: [
          { path: '', component: OrderListComponent, data: { animation: 'OrderList' } },
          { path: 'example-menu', component: ExampleMenuComponent, data: { animation: 'ExampleMenu' } },
